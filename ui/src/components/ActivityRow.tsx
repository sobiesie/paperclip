...
const ACTION_VERBS: Record<string, string> = {
  ...
  "issue.work_product_created": "created a work product for",
  "issue.work_product_updated": "updated a work product on",
  "issue.work_product_deleted": "deleted a work product from",
